export default {
  ...
  pages: {
    ...
    bots: {
      ...
      pauseAllBots: 'Pausar todos los bots seleccionados o visibles',
      resumeAllBots: 'Reanudar todos los bots seleccionados o visibles',
      stopBuyingAllBots: 'Detener compra en todos los bots seleccionados o visibles',
      resumeBuyingAllBots: 'Reanudar compra en todos los bots seleccionados o visibles',      stopBuyingOnDropAllBots: 'Detener compra en caída (todos los bots seleccionados o visibles)',
      resumeBuyingOnDropAllBots: 'Reanudar compra en caída (todos los bots seleccionados o visibles)',
      stopBuyingOnRebuyAllBots: 'Detener compra en recompra (todos los bots seleccionados o visibles)',
      resumeBuyingOnRebuyAllBots: 'Reanudar compra en recompra (todos los bots seleccionados o visibles)',      addBot: 'Añadir un bot',
