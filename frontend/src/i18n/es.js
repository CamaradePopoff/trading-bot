export default {
  ...
  pages: {
    ...
    bots: {
      ...
      pauseAllBots: 'Pausar todos los bots visibles',
      resumeAllBots: 'Reanudar todos los bots visibles',
      stopBuyingAllBots: 'Detener compra en todos los bots visibles',
      resumeBuyingAllBots: 'Reanudar compra en todos los bots visibles',      stopBuyingOnDropAllBots: 'Detener compra en caída (todos los bots visibles)',
      resumeBuyingOnDropAllBots: 'Reanudar compra en caída (todos los bots visibles)',
      stopBuyingOnRebuyAllBots: 'Detener compra en recompra (todos los bots visibles)',
      resumeBuyingOnRebuyAllBots: 'Reanudar compra en recompra (todos los bots visibles)',      addBot: 'Añadir un bot',
