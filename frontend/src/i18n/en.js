export default {
  ...
  pages: {
    ...
    bots: {
      ...
      pauseAllBots: 'Pause all selected bots',
      resumeAllBots: 'Resume all selected bots',
      stopBuyingAllBots: 'Stop buying on all selected bots',
      resumeBuyingAllBots: 'Resume buying on all selected bots',
      stopBuyingOnDropAllBots: 'Stop buying on drop (all selected bots)',
      resumeBuyingOnDropAllBots: 'Resume buying on drop (all selected bots)',
      stopBuyingOnRebuyAllBots: 'Stop buying on rebuy (all selected bots)',
      resumeBuyingOnRebuyAllBots: 'Resume buying on rebuy (all selected bots)',
      addBot: 'Add a bot',
