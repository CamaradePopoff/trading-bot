export default {
  ...
  pages: {
    ...
    bots: {
      ...
      pauseAllBots: 'Pause all selected or visible bots',
      resumeAllBots: 'Resume all selected or visible bots',
      stopBuyingAllBots: 'Stop buying on all selected or visible bots',
      resumeBuyingAllBots: 'Resume buying on all selected or visible bots',
      stopBuyingOnDropAllBots: 'Stop buying on drop (all selected or visible bots)',
      resumeBuyingOnDropAllBots: 'Resume buying on drop (all selected or visible bots)',
      stopBuyingOnRebuyAllBots: 'Stop buying on rebuy (all selected or visible bots)',
      resumeBuyingOnRebuyAllBots: 'Resume buying on rebuy (all selected or visible bots)',
      addBot: 'Add a bot',
