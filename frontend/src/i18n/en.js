export default {
  ...
  pages: {
    ...
    bots: {
      ...
      stopBuyingOnDropAllBots: 'Stop buying on drop (all visible bots)',
      resumeBuyingOnDropAllBots: 'Resume buying on drop (all visible bots)',
      stopBuyingOnRebuyAllBots: 'Stop buying on rebuy (all visible bots)',
      resumeBuyingOnRebuyAllBots: 'Resume buying on rebuy (all visible bots)',
      addBot: 'Add a bot',
