export default {
  ...
  pages: {
    ...
    bots: {
      ...
      stopBuyingOnDropAllBots: 'Arrêter les achats en baisse (tous les bots visibles)',
      resumeBuyingOnDropAllBots: 'Reprendre les achats en baisse (tous les bots visibles)',
      stopBuyingOnRebuyAllBots: 'Arrêter les achats en rachat (tous les bots visibles)',
      resumeBuyingOnRebuyAllBots: 'Reprendre les achats en rachat (tous les bots visibles)',
