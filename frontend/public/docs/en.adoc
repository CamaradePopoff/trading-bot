...
*Example Workflow:*
. Select the bots you want to control using checkboxes
. Click *Pause* to pause only those bots
. Your other bots continue operating normally
. Click *Stop Buying on Drop* to prevent drop-based buys on selected bots only
...
. *Stop Buying Active*: Check if "Stop Buying on Drop" or "Stop Buying on Rebuy" mode is enabled
+
