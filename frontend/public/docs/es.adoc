...
==== Modo Detener Compras
* Activado a través del botón "Detener Compras"
* El bot continúa vendiendo posiciones rentables pero no compra nuevas
* Útil para salir gradualmente de una posición
* Puede invertirse con el botón "Reanudar Compras"
...
. *Detener Compras Activo*: Verifica si el modo "Detener Compras" está habilitado
+
** Solución: Haz clic en "Reanudar Compras"
