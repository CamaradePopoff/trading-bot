...
mkdir -p kucoin binance mexc bybit
...
cd bybit && git clone git@github.com:CamaradePopoff/trading-bot.git . && cd ..
cd
...
cp kubot/kucoin/vps/kubot/bybit/.env.prod kubot/bybit/.env
